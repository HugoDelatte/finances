...
class Statement:
    ...
    """
    def __init__(self, statement_file, project_folder, prev_end_balance):
        ...
        self.error_folder = Path(PurePath(self.project_folder, file_name))
    ...
    def _get_entity_mapping_file(self):
        ...
        file_path = Path(PurePath(self.project_folder, file_name))
    ...
    def _create_error_folder(self):
        # error folder
        self.error_folder = Path(PurePath(self.project_folder, 'error'))
    ...
    def _save_error_file(self, mapping_error_list):
